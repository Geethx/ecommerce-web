                ...
                <div className="auth-container">
                    ...
                    <form className="auth-form" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-input" type="password" id="password" placeholder="Enter your password" {...register("password", { required: "Password is required", minLength: { value: 6, message: "Password must be at least 6 characters long" }, maxLength: { value: 12, message: "Password must be less than 12 characters long" } })} />
